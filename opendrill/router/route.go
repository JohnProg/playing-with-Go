...
func Init() {
	...
	router.Handle("/auth/", middleware.Handler(website.AuthUser)).Methods("POST")

	//Administrator
	router.Handle("/admin/organizations/", middleware.Handler(middleware.JWTMiddleware(admin.ListOrganizations))).Methods("GET")
